...
for i in range(100):
    thelist=ListGenerators.ScrambledTips(1000000,1,fraction=.3)
...
with open("//mfs01/user01/SGDJAME4/MWSDesktop/MSc project/ScrambledTipsTimesList.txt", "w") as output:
