...
for i in range(100):
    thelist=ListGenerators.RepeatingEntries(1000000,-5000000,5000000)
...
with open("//mfs01/user01/SGDJAME4/MWSDesktop/MSc project/RepeatingEntriesTimesList.txt", "w") as output:
