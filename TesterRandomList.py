...
from QuickSortWithRecursion import QuickSortwithRecursion
import ListGenerators

TimesList=[[] for i in range(10)]

for i in range(100):
    thelist=ListGenerators.RandomList(1000000,-5000000,5000000)
...
with open("//mfs01/user01/SGDJAME4/MWSDesktop/MSc project/RandomListTimesList.txt", "w") as output:
